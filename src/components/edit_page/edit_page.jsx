                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Sahifani o'zgartirish</h4>
                                    <form autoComplete="off" class="el_form page_form" onSubmit={(e) => {
                                        e.preventDefault()
                                        let body = {
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Nomini kiriting o'zbek
                                                tilida</label>
                                            <div class="col-sm-10">
                                                <input type="text" ref={page_name_uz} class="form-control page_name_uz" name="section_name_uz" defaultValue={found.section_name_uz} required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Nomini kiriting rus
                                                tilida</label>
                                            <div class="col-sm-10">
                                                <input type="text" ref={page_name_ru} class="form-control page_name_ru" name="section_name_ru" defaultValue={found.section_name_ru} required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Nomini kiriting ingliz
                                                tilida</label>
                                            <div class="col-sm-10" >
                                                <input type="text" class="form-control page_name_en" name="section_name_en" defaultValue={found.section_name_en} ref={page_name_en} required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Bo'lim turini tanlang</label>
                                            <div class="col-sm-10" >
                                                <select name="subCategoryId menu_id" class="main_selector form-control" defaultValue={found.menu_id} ref={page_main_id}>
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Yo'nalishni tanlang</label>
                                            <div class="col-sm-10" >
                                                <select class="filter_selector form-control" name="menu_id" ref={page_filter_id}>
                                                    <option value="0">Kerak emas</option>
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Sarlavhasini kiriting o'zbek
                                                tilida</label>
                                            <div class="col-sm-10" >
                                                <input ref={page_title_uz} defaultValue={found.section_title_uz} type="text" class="form-control page_title_uz" name="section_title_uz" required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Sarlavhasini kiriting rus
                                                tilida</label>
                                            <div class="col-sm-10" >
                                                <input ref={page_title_ru} defaultValue={found.section_title_ru} type="text" class="form-control page_title_ru" name="section_title_ru" required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Sarlavhasini kiriting ingliz
                                                tilida</label>
                                            <div class="col-sm-10" >
                                                <input ref={page_title_en} defaultValue={found.section_title_en} type="text" class="form-control page_title_en" name="section_title_en" required />
                                            </div>
                                        </div>
                                        <div class="pageBody mt-3">
                                            <label class="col-sm-2 col-form-label">Sahifaning asosini kiriting o'zbek tilida</label>
                                            <Editor
                                        ...
                                        <div class="pageBody mt-3">
                                            <label class="col-sm-2 col-form-label">Sahifaning asosini kiriting rus tilida</label>
                                            <Editor
                                        ...
                                        <div class="pageBody mt-3">
                                            <label class="col-sm-2 col-form-label">Sahifaning asosini kiriting ingliz tilida</label>
                                            <Editor
