                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="mt-0 header-title">Yangi Sahifa qo'shish</h4>
                                    <form autoComplete="off" class="el_form page_form" onSubmit={(e) => {
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Nomini kiriting o'zbek
                                                tilida</label>
                                            <div class="col-sm-10">
                                                <input type="text" ref={page_name_uz} class="form-control page_name_uz" name="section_name_uz" required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Nomini kiriting rus
                                                tilida</label>
                                            <div class="col-sm-10">
                                                <input type="text" ref={page_name_ru} class="form-control page_name_ru" name="section_name_ru" required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Nomini kiriting ingliz
                                                tilida</label>
                                            <div class="col-sm-10" >
                                                <input type="text" class="form-control page_name_en" name="section_name_en" ref={page_name_en} required />
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label for="example-text-input" class="col-sm-2 col-form-label">Sahifa Sarlavhasini kiriting ingliz
                                                tilida</label>
                                            <div class="col-sm-10" >
                                                <input ref={page_title_en} type="text" class="form-control page_title_en" name="section_title_en" required />
                                            </div>
                                        </div>
