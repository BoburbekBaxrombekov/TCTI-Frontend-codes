              ...
              <div class="row">
                <div class="col-lg-10 col-md-12">
                  ...
                  <div id="About" ref={tabOne} class="tabcontent opened">
                    ...
                    <p>{context[lang].kafedraAbout27.first}</p>
                    <p>{context[lang].kafedraAbout27.second}</p>
                  </div>

                  <div id="Functions" ref={tabTwo} class="tabcontent">
                    <h3>Kafedraning o'quv-uslubiy ishlari</h3>
                    <p>{context[lang].kafedraPersonnelTraining27.first}</p>
                    <p>{context[lang].kafedraPersonnelTraining27.second}</p>
                  </div>

                  <div id="Management" ref={tabThree} class="tabcontent">
                    <h3>Kafedra ilmiy ishlari</h3>
                    <p>{context[lang].kafedraScientificDirections27.first}</p>
                  </div>
                </div>
              </div>
              <div class="row">
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">
                              <p>{context[lang].kafedraDagree27.first}</p>
                            </span>
                            <span class="info">
                              <p>{context[lang].kafedraDagree27.fivth}</p>

                              <p>{context[lang].kafedraDagree27.third}</p>
                              <br />
                              <p>{context[lang].kafedraDagree27.fourth}</p>
                            </span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                        {context[lang].kafedraDagree27.first}
                      </h6>
                    </div>
                  </div>
                </div>
