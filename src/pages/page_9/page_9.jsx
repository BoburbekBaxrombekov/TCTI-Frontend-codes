                                ...
                                <div class="col-md-10">
                                    <div class="teachers">
                                        <div class="wrapper-personal">
                                            <div class="photo-personal">
                                                ...
                                                <div class="photo__large">
                                                    <div class="bg-text">
                                                        ...
                                                        <span class="info">{context[lang].monitoring.m9}
                                            ...
                                            <h6 class="fullname-personal">{context[lang].monitoring.m9}</h6>
                                        </div>
                                        <div class="wrapper-personal">
                                            <div class="photo-personal">
                                                ...
                                                <div class="photo__large">
                                                    <div class="bg-text">
                                                        ...
                                                        <span class="info">{context[lang].monitoring.m11}
                                            ...
                                            <h6 class="fullname-personal">{context[lang].monitoring.m11}</h6>
                                        </div>
                                        <div class="wrapper-personal">
                                            <div class="photo-personal">
                                                ...
                                                <div class="photo__large">
                                                    <div class="bg-text">
                                                        <span class="degree">{context[lang].monitoring.m12}</span>
                                                        <span class="info">{context[lang].monitoring.m13}
                                            ...
                                            <h6 class="fullname-personal">{context[lang].monitoring.m13}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
