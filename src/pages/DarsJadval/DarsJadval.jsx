            ...
            <div className="container-pages">
                ...
                <div className="mainsss">
                    <div className='page_main'>
                        ...
                        <div class="table-responsive-md table-wrapp">
                            <table class="table align-middle table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><a href=" " class="table-button">{context[lang].DarsJadval.t2}</a></td>
                                    <td><a href=" " class="table-button">{context[lang].DarsJadval.t3}</a></td>
                                    <td><a href=" " class="table-button">{context[lang].DarsJadval.t4}</a></td>
                                    <td><a href=" " class="table-button">{context[lang].DarsJadval.t5}</a></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2"><a href=" " class="table-button">{context[lang].DarsJadval.t2}</a></td>
                                    <td colspan="2"><a href=" " class="table-button">{context[lang].DarsJadval.t3}</a></td>
                                </tr>
                            </table>
                        </div>
                    </div>
