                            ...
                            <div class="teachers">
                                <div class="wrapper-personal">
                                    <div class="photo-personal">
                                        ...
                                        <div class="photo__large">
                                            <div class="bg-text">
                                                <span class="degree">{context[lang].kaf2.p10}</span>
                                                <span class="info">
                                                {context[lang].kaf2.p11}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <h6 class="fullname-personal">{context[lang].kaf2.p12}</h6>
                                </div>
                                ...
                                <div class="wrapper-personal">
                                    <div class="photo-personal">
                                        ...
                                        <div class="photo__large">
                                            <div class="bg-text">
                                                <span class="degree">{context[lang].kaf2.p13}</span>
                                                <span class="info">{context[lang].kaf2.p14} </span>
                                            </div>
                                        </div>
                                    </div>
                                    <h6 class="fullname-personal">{context[lang].kaf2.p15}</h6>
                                </div>
                                <div class="wrapper-personal">
                                    <div class="photo-personal">
                                        ...
                                        <div class="photo__large">
                                            <div class="bg-text">
                                                <span class="degree">{context[lang].kaf2.p16}</span>
                                                <span class="info">{context[lang].kaf2.p17}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <h6 class="fullname-personal">{context[lang].kaf2.p18}</h6>
                                </div>
