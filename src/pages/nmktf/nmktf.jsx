                            ...
                            <div class="col-md-10">
                                <div class="teachers justify-content-center">
                                    <div class="wrapper-personal">
                                        ...
                                        <h6 class="fullname-personal">{context[lang].facultet4.a22}</h6>
                                    </div>
                                    <div class="wrapper-personal">
                                        <div class="photo-personal">
                                            ...
                                            <div class="photo__large">
                                                <div class="bg-text">
                                                    <span class="degree">{context[lang].bizningManzil.second}</span>
                                                    <span class="info"><b></b>
                                                        <br />
                                        ...
                                        <h6 class="fullname-personal">{context[lang].facultet4.a24}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
