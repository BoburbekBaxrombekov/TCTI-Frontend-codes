                                    ...
                                    <div class="wrapper-personal">
                                        <div class="photo-personal">
                                            ...
                                            <div class="photo__large">
                                                <div class="bg-text">
                                                    <span class="degree">{context[lang].Akademik_Litsey.tenth}</span>
                                                    <span class="info"><br />
                                        ...
                                        <h6 class="fullname-personal">{context[lang].Akademik_Litsey.eleventh}</h6>
                                    </div>
                                    <div class="wrapper-personal">
                                        <div class="photo-personal">
                                            <img class="images-personal" src={YoshlarItt2} alt="About us" />
                                            <div class="photo__large">
                                                <div class="bg-text">
                                                    <span class="degree">{context[lang].Akademik_Litsey.thirteenth}</span>
                                                    <span class="info">
                                        ...
                                        <h6 class="fullname-personal">Ernazarov Davronbek Javlon o‘g‘li</h6>
                                    </div>
                                    <div class="wrapper-personal">
                                        <div class="photo-personal">
                                            <img class="images-personal" src={YoshlarItt3} alt="About us" />
                                            <div class="photo__large">
                                                <div class="bg-text">
                                                    <span class="degree">{context[lang].Akademik_Litsey.sixteenth}</span>
                                                    <span class="info">
                                        ...
                                        <h6 class="fullname-personal">{context[lang].Akademik_Litsey.seventeenth}</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
