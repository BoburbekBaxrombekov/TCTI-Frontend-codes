              ...
              <div class="row">
                <div class="col-lg-10 col-md-12">
                  ...
                  <div id="About" ref={tabOne} class="tabcontent opened">
                    ...
                    <p>{context[lang].kafedraAbout31.first}</p>
                  </div>

                  <div id="Functions" ref={tabTwo} class="tabcontent">
                    <h3> {context[lang].kafedraIfoSelect.second}</h3>
                    <p>{context[lang].kafedraPersonnelTraining31.first}</p>
                  </div>
                  <div id="Management" ref={tabThree} class="tabcontent">
                    <h3>{context[lang].kafedraIfoSelect.third}</h3>
                    <p>
                      {context[lang].kafedraScientificDirections31.first}
                      {context[lang].kafedraScientificDirections31.second}
                      {context[lang].kafedraScientificDirections31.third}
                      {context[lang].kafedraScientificDirections31.fourth}
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">
                              {context[lang].kafedraDagree31.first}
                            </span>
                            <span class="info">
                              {context[lang].kafedraDagree31.third} <br />
                              {context[lang].kafedraDagree31.fourth} <br />
                              {context[lang].kafedraDagree31.fifth}
                            </span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                        {" "}
                        {context[lang].kafedraDagree31.second}
                      </h6>
                    </div>
                  </div>
                </div>
