                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">
                              {context[lang].kafedraDagree32.first}
                            </span>
                            <span class="info">
                              {context[lang].kafedraDagree32.third}
                              <br />
                              {context[lang].kafedraDagree32.fourth} <br />
                              {context[lang].kafedraDagree32.fifth}
                            </span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                        {" "}
                        {context[lang].kafedraDagree32.second}
                      </h6>
                    </div>
                  </div>
                </div>
