                  ...
                  <div class="teachers">
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p10}</span>
                            <span class="info">{context[lang].kaf3.p11}</span>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p13}</span>
                            <span class="info">{context[lang].kaf3.p14}</span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p16}</span>
                            <span class="info">{context[lang].kaf3.p17}</span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p19}</span>
                            <span class="info">{context[lang].kaf3.p20}</span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p22}</span>
                            <span class="info">{context[lang].kaf3.p23}</span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p25}</span>
                            <span class="info">{context[lang].kaf3.p26}</span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p28}</span>
                            <span class="info">{context[lang].kaf3.p29}</span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
                    ...
                    <div class="wrapper-personal">
                      <div class="photo-personal">
                        ...
                        <div class="photo__large">
                          <div class="bg-text">
                            <span class="degree">{context[lang].kaf3.p31}</span>
                            <span class="info">{context[lang].kaf3.p32}</span>
                          </div>
                        </div>
                      </div>
                      <h6 class="fullname-personal">
